...
int main(int argc, char const *argv[]) {
    ...
    matrix<containers::vect<double, 3>> in_double(in_data.x(), in_data.y());
    std::transform(in_data.begin(), in_data.end(), in_double.begin(),
                   [](const RGB &in) {
                       containers::vect<double, 3> out;
                       out[0] = in.r;
                       out[1] = in.g;
                       out[2] = in.b;
                       return out;
