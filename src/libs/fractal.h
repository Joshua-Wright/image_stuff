...
namespace image_utils {
    ...
    /** bounds is in the form {xmin, xmax, ymin, ymax} */
    matrix<double> fast_mandelbrot(const size_t w, const size_t h, const size_t iter, const std::array<double, 4> bounds, bool do_grid = false);

    /** bounds is in the form {xmin, xmax, ymin, ymax} */
    matrix<double> fast_julia(const size_t w, const size_t h, const size_t iter, const std::array<double, 4> bounds, complex c, bool do_grid = false);
